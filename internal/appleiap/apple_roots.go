...
// Official Apple Root CA certificates (https://www.apple.com/certificateauthority/).
// Embedded so JWS verification works in Docker/Alpine and other images whose system
// trust store may not include Apple's PKI roots (fixes "cert chain verify failed").
//
// Apple Root CA - G2 (RSA chains) and G3 (ECC chains, common for ES256 JWS).
